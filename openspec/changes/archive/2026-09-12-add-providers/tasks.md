...
- [x] 3.5 Aplicar los patrones de `docs/design-system.md`, navegación por teclado, foco visible, etiquetas asociadas y layout de una columna en móvil; verificarlo con Playwright en viewport móvil y escritorio.
...
- [x] 4.2 Agregar pruebas end-to-end del CRUD completo y del rechazo de un proveedor inactivo en una nueva afiliación; verificar confirmaciones visuales y persistencia tras recargar.
