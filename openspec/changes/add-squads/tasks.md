...
- [ ] 1.2 Agregar la migración Alembic para crear `squads`, incluyendo columnas obligatorias, valores nulos para tribu/PO e índice único insensible a mayúsculas para el código; verificar que aplique y revierta sin afectar otras tablas.
...
- [ ] 3.6 Aplicar el sistema visual y accesibilidad responsive del proyecto; verificar con Playwright navegación por teclado, foco visible, labels asociadas y ausencia de overflow horizontal en móvil.
...
- [ ] 4.2 Ejecutar una prueba end-to-end del ciclo completo de un Squad; verificar creación, consulta, edición, desactivación, consulta como inactivo y reactivación.
